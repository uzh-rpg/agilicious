...
(`SciRob21_Foehn <https://rpg.ifi.uzh.ch/docs/ScienceRobotics21_Foehn.pdf>`__,
`Video <https://youtu.be/ZPI8U1uSJUs>`___), vision-based acrobatic flight
(`RSS20 Kaufmann <https://rpg.ifi.uzh.ch/docs/RSS20_Kaufmann.pdf>`__, 
`Video <https://youtu.be/2N_wKXQ6MXA>`___),
obstacle avoidance in both structured and unstructured environments using solely onboard perception
(`SciRob21_Loquercio <https://rpg.ifi.uzh.ch/docs/Loquercio21_Science.pdf>`__,
`Video <https://www.youtube.com/watch?v=m89bNn6RFoQ>`__), and hardware-in-the-loop simulation in virtual-reality environments.
...
The full list of publications using Agilicious can be found `here <https://rpg.ifi.uzh.ch/aggressive_flight.html>`__.
